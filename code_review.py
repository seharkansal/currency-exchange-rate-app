...
def write_data_to_db(date1, base, rate):
    ...
    command1 = "INSERT INTO Currency_exchange (primary_key,DATE,COUNTRY,BASE,RATE) VALUES ('{}','{}','{}','{}',{})".format(
        primary_key, date1, country, base, rate
    )
...
def user_fetch(date, base, country):
    ...
    """
    command = (
        '''SELECT COUNT(primary_key) FROM currency_exchange WHERE currency_exchange.primary_key="'''
        + country
        + """_"""
        + date
        + '''"'''
    ...
    if new_list[0] == 1:
        #print("yes")
        result = conn.execute(
            '''SELECT RATE FROM currency_exchange WHERE currency_exchange.primary_key="'''
            + country
            + """_"""
            + date
            + '''"'''
    ...
    while True:
        ...
        if choice == 1:
            ...
            print(
                ...
                country,
                "is:",
                user_fetch(date_country, base, country),
            )
